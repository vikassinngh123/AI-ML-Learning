...
- **Key Projects:**
  ...
  - **Live Web Deployment:** Turned the landscape classifier into an interactive Streamlit web app, handling custom image pre-processing pipelines and hosting model weights efficiently.
